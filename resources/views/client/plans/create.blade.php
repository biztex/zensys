...
<!--                         <div class="form-group row">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="notice" type="text" name="notice" value="{{ old('notice') }}">or
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="road_eat1_1" type="radio"  name="road_eat1_1" value="1" @if(old('road_eat1')) checked @endif>あり
                                <input id="road_eat1_0" type="radio"  name="road_eat1_1" value="0" @if(!old('road_eat1')) checked @endif>なし
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> {{ __('昼食') }}</label>
                            <div class="col-md-6">
                                <input id="road_eat2_1" type="radio"  name="road_eat2_1" value="1" @if(old('road_eat2')) checked @endif>あり
                                <input id="road_eat2_0" type="radio"  name="road_eat2_1" value="0" @if(!old('road_eat2')) checked @endif>なし
                            </div>
                            </div>
                          <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> {{ __('夕食') }}</label>
                            <div class="col-md-6">
                                <input id="road_eat3_1" type="radio"  name="road_eat3_1" value="1" @if(old('road_eat3')) checked @endif>あり
                                <input id="road_eat3_0" type="radio"  name="road_eat3_1" value="0" @if(!old('road_eat3')) checked @endif>なし
                            </div>
                        </div>
                        <div class="form-group row">

                ...
                <div class="card-body">
                    ...
                    <form action="{{config('app.url')}}client/plans/update/{{ $plans->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="name" type="textarea" class="form-control" name="catchphrase" rows="5" placeholder="※最大100文字まで">{{ old('catchphrase',$plans->catchphrase) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> プラン説明文</label>
                            <div class="col-md-8">
                                <textarea id="name" type="textarea" class="form-control" name="description" rows="15" placeholder="※最大1200文字まで">{{ old('description',$plans->description) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="notice" type="text" name="notice" value="{{ old('notice',$plans->notice) }}">or
                                <input type="file" name="file_path11">
                            @empty ($plans->file_path11)
                             
                              @else
                              <a href="{{config('app.url')}}uploads/{{ $plans->file_path11 }}" >{{ $plans->file_path11 }}</a>
                            
                              <input id="hidden11" type="hidden" name="old_file_path11" value="{{ old('file_path6',$plans->file_path11) }}"><input type="checkbox" name="del_fiel11" value="1">削除
                              @endempty
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="institution" type="textarea" class="form-control" name="institution" rows="5" placeholder="※最大100文字まで">{{ old('institution',$plans->institution) }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="transportation" type="textarea" class="form-control" name="transportation" rows="5" placeholder="※最大100文字まで">{{ old('transportation',$plans->transportation) }}</textarea>
...
<!--                         <div class="form-group row mb-0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="road_eat1_1" type="radio"  name="road_eat1_{{ $loop->index + 1 }}" value="1" @if($road_map->road_eat1) checked @endif>あり
                                <input id="road_eat1_0" type="radio"  name="road_eat1_{{ $loop->index + 1 }}" value="0" @if(!$road_map->road_eat1)) checked @endif>なし
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> {{ __('昼食') }}</label>
                            <div class="col-md-6">
                                <input id="road_eat2_1" type="radio"  name="road_eat2_{{ $loop->index + 1 }}" value="1" @if($road_map->road_eat2) checked @endif>あり
                                <input id="road_eat2_0" type="radio"  name="road_eat2_{{ $loop->index + 1 }}" value="0"  @if(!$road_map->road_eat2)) checked @endif>なし
                            </div>
                            </div>
                          <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> {{ __('夕食') }}</label>
                            <div class="col-md-6">
                                <input id="road_eat3_1" type="radio"  name="road_eat3_{{ $loop->index + 1 }}" value="1" @if($road_map->road_eat3) checked @endif>あり
                                <input id="road_eat3_0" type="radio"  name="road_eat3_{{ $loop->index + 1 }}" value="0"  @if(!$road_map->road_eat3)) checked @endif>なし
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <script>CKEDITOR.replace( 'road_map{{ $loop->index + 1 }}' );</script>
                    <div class="after-road-section-{{ $loop->index + 1 }}"></div>
                         @endforeach
...
<!--                             <label class="checkbox-inline">
                       ...
                       <!--  <div class="form-group row mt-4">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="checkbox-inline">
                              <input class="ml-5" type="checkbox" name="prepay" value="1" @if ($plans->prepay == 1) checked @endif> <span> 事前払い</span>
                            </label>
                            <label class="radio-inline">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="name" type="textarea" class="form-control" name="payment_comment" rows="2" placeholder="※最大200文字まで">{{ old('payment_comment',$plans->payment_comment) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-5 bg-dark">
 ...
 <!--                        <div class="form-group row">
					...
					@endforeach
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-md-6">
                                <textarea id="name" type="textarea" class="form-control" name="included_item" rows="2" placeholder="※最大100文字まで">{{ old('included_item',$plans->included_item) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="name" type="textarea" class="form-control" name="question_content" rows="10" placeholder="※最大1200文字まで">{{ old('question_content',$plans->question_content) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"></label>
                            <div class="col-md-6">
                                <textarea id="name" type="textarea" class="form-control" name="caution_content" rows="10" placeholder="※最大5000文字まで">{{ old('caution_content',$plans->caution_content) }}</textarea>
                            </div>
                        </div>
<!--                         <div class="form-group row mt-5 bg-dark">

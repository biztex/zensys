        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{config('app.url')}}client/users/store" method="POST">
                        @csrf
                        @method('POST')
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('性') }}</label>
                            <div class="col-md-2">
                                <input id="" type="text" class="form-control" name="name_last" value="{{ old('name_last') }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('名') }}</label>
                            <div class="col-md-2">
                                <input id="" type="text" class="form-control" name="name_first" value="{{ old('name_first') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('セイ') }}</label>
                            <div class="col-md-2">
                                <input id="" type="text" class="form-control" name="kana_last" value="{{ old('kana_last') }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('メイ') }}</label>
                            <div class="col-md-2">
                                <input id="" type="text" class="form-control" name="kana_first" value="{{ old('kana_first') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('電話番号') }}</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="tel" value="{{ old('tel') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">{{ __('電話番号2') }}</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="tel2" value="{{ old('tel2') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="email2" value="{{ old('email2') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">{{ __('お客様番号') }}</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="customer_number" value="{{ old('customer_number') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="gender">
                                  ...
                                  <option value="0" @if(old('gender', '0')==0) selected  @endif>回答しない</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input id="" type="date" class="form-control" name="birth_day" value="{{ old('birth_day') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('郵便番号') }}</label>
                            <div class="col-md-3">
                                <input id="" type="text" class="form-control" name="postal_code" value="{{ old('postal_code') }}"   onKeyUp="AjaxZip3.zip2addr(this,'','prefecture','address');">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="address2" value="{{ old('address2') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">{{ __('メモ（社内用）') }}</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="memo" value="{{ old('memo') }}">
                            </div>
                        </div>
                        <div class="form-group row">

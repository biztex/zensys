...
<title>CARTEL | 会員情報の変更　DEALER</title>
								...
								<div class="mypageBox">
									...
									<div class="mypageUl">
										<ul>
											...
											<li><a href="edit_dealer.html">会員情報の変更</a></li>
									...
									<div class="mypageUl">
										...
										<ul>
											<li><a href="explore.html#exploreItem">お問い合わせ</a></li>
										</ul>
									</div>
								</div>
							</div>
										...
										<form action="#">
											...
											<table>
												<tbody>
													...
													<tr>
														<th><p>ショップ名<span>必須</span></p></th>
														<td><p><input type="text" placeholder="○○○○ショップ" value="○○○○ショップ"></p></td>
													</tr>
													<tr>
														<th><p>会社名</p></th>
														<td><p><input type="text" placeholder="○○○○会社" value="○○○○会社"></p></td>
													</tr>
													<tr>
														<th><p>担当者名<span>必須</span></p></th>
														<td>
															<p class="name">
													...
													<tr>
														<th><p>古物商許可証番号<span>必須</span></p></th>
											...
											<p class="privateUserSub privateUserSub02">詳細情報</p>
											<table>
												<tbody>
													<tr>
														<th><p>ディーラー写真</p></th>
														<td>
															<p>
																<label class="fileBox" for="fileinp01">
																	<input type="button" id="btn" value="ファイルを選択"><span id="text01">usericon.jpg</span>
																	<input type="file" id="fileinp01" accept='image/*' onchange="previewImage02(this);">
																</label>
															</p>
															<p class="change01"><img id="preview02" src="img/change/images03.jpg" style="max-width:280px;"></p>
														</td>
													</tr>
													<tr>
														<th><p>HP URL</p></th>
														<td><p><input type="text" placeholder="https://www.example.com" value="https://www.example.com"></p></td>
													</tr>
													<tr>
														<th><p>紹介文章</p></th>
														<td><p><textarea>PRコメントテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキ</textarea></p></td>
													</tr>
												</tbody>
											</table>
...
<script>
function previewImage02(obj)
{
	var fileReader = new FileReader();
	fileReader.onload = (function() {
		document.getElementById('preview02').src = fileReader.result;
	});
	fileReader.readAsDataURL(obj.files[0]);
}
</script>
...
$("#fileinp01").change(function () {
    $("#text01").html($("#fileinp01").val());
})
</script>
</body>
</html>

                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="is_listed">
                                  ...
                                  <option value="1" @if(old('is_listed',$publishers->is_listed)==1) selected  @endif>許可する</option>
                                  <option value="0" @if(old('is_listed',$publishers->is_listed)==0) selected  @endif>許可しない</option>
                                </select>
                            </div>
                        </div>
-->
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ old('name',$publishers->name) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('サイトタイトル') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="title" value="{{ old('title',$publishers->title) }}" placeholder="スマートタイムス">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('URL') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="link" value="{{ old('link',$publishers->link) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('サブタイトル') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="description" value="{{ old('description',$publishers->description) }}" placeholder="スマートなニュースをすべての人へ">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('出稿日時') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="pubdate" value="{{ old('pubdate',$publishers->pubdate) }}" placeholder="Wed, 01 Sep 2021 15:00:00 +0900">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('コピーライト') }}</label>
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="copyright" value="{{ old('copyright',$publishers->copyright) }}" placeholder="© SmartNews, Inc.">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-md-2 col-form-label text-md-right">{{ __('ロゴ画像') }}</label>
                            <div id="div-img1" class="col-md-4">
                              @empty ($publishers->file_path1)
                              <input type="file" name="file_path1">
                              @else
                              <img id="img1" src="/public/uploads/{{ $publishers->file_path1 }}" width="auto" height="150px">
                              <input id="hidden1" type="hidden" name="old_file_path1" value="{{ old('file_path1',$publishers->file_path1) }}">
                              @endempty
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div id="div-img2" class="col-md-4">
                              @empty ($publishers->file_path2)
                              <input type="file" name="file_path2">
                              @else
                              <img id="img2" src="/public/uploads/{{ $publishers->file_path2 }}" width="auto" height="150px">
                              <input id="hidden2" type="hidden" name="old_file_path2" value="{{ old('file_path2',$publishers->file_path2) }}">
                              @endempty
                            </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="/admin/publishers" class="btn btn-secondary">戻る</a>
                            </div>
                        </div>
                    </form>
                </div>

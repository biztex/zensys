...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('admin.forgot')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('admin.forgot')); ?>">
...
<?php endif; ?>
<?php /**PATH /var/www/html/zenryo/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>
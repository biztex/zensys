...
-->        
         <?php $__env->endSlot(); ?>
        <div>
            <img class="d-block mx-auto" width="200"  src="<?php echo e(asset('img//logo_login.png')); ?>">
        </div>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('client.forgot')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('client.forgot')); ?>">
...
<?php endif; ?>
<?php /**PATH E:\Task\crowd\_08_laravel\zenryo\resources\views/client/auth/login.blade.php ENDPATH**/ ?>
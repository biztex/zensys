...
<div class="row mb-2">
  ...
  <div class="col-sm-6 mt-3">
    <a href="<?php echo e(config('app.url')); ?>client/users/create" class="btn btn-primary float-right">新規追加</a>　
    <a href="<?php echo e(config('app.url')); ?>client/users/csv" class="btn btn-success float-right mr-3">CSVダウンロード</a>　
  </div>
</div>
<div id="result"></div>
<div class="row mb-2">
  <div class="col-sm-12 mt-4">
    <form method="post" name="form" action="<?php echo e(config('app.url')); ?>client/users/destroy-selected">
      <?php echo csrf_field(); ?>
...
new gridjs.Grid ({
  ...
  columns: [
    ...
    { 
      ...
      sort: false,
        formatter: (_, row) => gridjs.html(`
          <div class="row">
            <a href="<?php echo e(config('app.url')); ?>client/users/edit/${row.cells[1].data}" class="btn btn-warning btn-sm">編集</a>　
  ...
  server: {
    url: '<?php echo e(config('app.url')); ?>client/users/json',
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/zenryo/resources/views/client/users/index.blade.php ENDPATH**/ ?>